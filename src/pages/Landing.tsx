...
const platforms = [
  { icon: <MetaIcon size={32} className="text-[hsl(214,100%,45%)]" />, name: 'Instagram/Meta' },
  { icon: <GoogleIcon size={32} />, name: 'Google Ads' },
  { icon: <TikTokIcon size={32} className="text-[hsl(180,76%,48%)]" />, name: 'TikTok Ads' },
];
      ...
      <header className="border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-foreground">Portal de Resultados</span>
          </div>
          <Link to="/login">
            <Button>
              Entrar no painel
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 lg:py-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
            {platforms.map((platform) => (
              <div key={platform.name} className="flex items-center gap-3 opacity-80 hover:opacity-100 transition-opacity">
                {platform.icon}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="bg-card rounded-xl border border-border p-6 hover:shadow-elevated transition-all duration-300 hover:-translate-y-1 animate-slide-up"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                'Dados atualizados das suas campanhas em tempo real',
                'Comparativo entre períodos para análise de evolução',
                'Relatórios exportáveis em PDF e CSV',
                'Acesso seguro exclusivo para cada cliente',
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-foreground">Portal de Resultados</span>
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <a
                href="mailto:contato@portal.com"
                className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
                <Mail size={16} />
                E-mail
