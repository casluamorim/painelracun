    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl bg-[hsl(180,76%,48%)]/10 flex items-center justify-center">
            <TikTokIcon size={28} className="text-[hsl(180,76%,48%)]" />
          </div>
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-foreground">TikTok Ads</h1>
            <p className="text-muted-foreground">Desempenho das campanhas no TikTok Ads</p>
          </div>
        </div>
        <PeriodFilter />
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard
          ...
          trend={{ value: 24.3, label: 'vs período anterior' }}
        ...
        <MetricCard
          ...
          trend={{ value: 31.2, label: 'vs período anterior' }}
          icon={<Target size={20} />}
        />
        <MetricCard
          title="Impressões"
          value={formatNumber(totals.impressions)}
          trend={{ value: 45.8, label: 'vs período anterior' }}
          icon={<Eye size={20} />}
        />
        <MetricCard
          title="Cliques"
          value={formatNumber(totals.clicks)}
          trend={{ value: 38.5, label: 'vs período anterior' }}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <MetricCard
          title="CPL"
          value={cpl !== 'N/A' ? formatCurrency(Number(cpl)) : 'N/A'}
          icon={<Target size={18} />}
        />
      </div>
      ...
      <SpendChart
        ...
        title="Investimento Diário - TikTok Ads"
      />

      {/* Campaign Table */}
      <div>
        <h2 className="text-xl font-semibold text-foreground mb-4">Campanhas TikTok Ads</h2>
